...
Automatically reduces token usage in OpenCode by managing conversation context intelligently.
...
```jsonc
{
    "$schema": "https://raw.githubusercontent.com/tainn03/opencode-context-pruner/main/dcp.schema.json",
